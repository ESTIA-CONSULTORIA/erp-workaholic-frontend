...
type Vista = 'productos' | 'insumos' | 'clientes' | 'proveedores';
...
const CONDICIONES_PAGO = ['Contado','7 días','15 días','30 días','45 días','60 días'];
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, marginBottom:12 }}>
              ...
              <div>
                ...
                <select className="input-base" style={{ fontSize:13 }} value={form.paymentTerms}
                  ...
                  {CONDICIONES_PAGO_PAGO.map(c => <option key={c} value={c}>{c}</option>)}
                </select>
              </div>
              <div>
                <label style={{ fontSize:11, color:'#64748b', display:'block', marginBottom:3 }}>Límite de crédito</label>
